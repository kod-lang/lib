...
static inline void string_init_from_test(void);
static inline void string_deinit_test(void);
static inline void string_new_test(void);
static inline void string_new_with_capacity_test(void);
static inline void string_new_from_test(void);
static inline void string_free_test(void);
...
int main(void)
{
  ...
  string_init_from_test();
  string_deinit_test();
  string_new_test();
  string_new_with_capacity_test();
  string_new_from_test();
  string_free_test();
  string_release_test();
  string_hash_test();
  return EXIT_SUCCESS;
